(function(){
  // Build mobile menu drawer + hamburger and inject into header
  const nav = document.querySelector('header.nav .container');
  if(!nav) return;

  // Current page name for active state
  ...
  drawer.innerHTML = `
    ...
    <aside class="mnav-panel" role="dialog" aria-label="Site menu">
      <div class="mnav-head">
        <a class="mnav-logo" href="index.html"><img src="assets/oe-logo.png" alt="OE Services"/></a>
